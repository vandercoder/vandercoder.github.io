...
$(".tech-stack").click(function () {
  if (!this.classList.contains("active")) {
    $(".tech-stack.active").addClass(
      "border-black text-gray-800 hover:bg-gray-400 hover:text-gray-800"
    );
    $(".tech-stack.active").removeClass("active bg-gray-800 text-white");
    $(this).removeClass(
      "border-black hover:border-gray-200 text-gray-800 hover:bg-gray-200"
    );
